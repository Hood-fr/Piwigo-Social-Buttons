{strip}
{if $SOCIALBUTT.light}
  <a title="Share on LinkedIn" href="https://www.linkedin.com/shareArticle?mini=true&url={$SOCIALBUTT.share_url|urlencode}&title={$PAGE_TITLE|cat:' - '|cat:$GALLERY_TITLE}&source={$GALLERY_TITLE}&summary={$CONTENT_DESCRIPTION|strip_tags:false|escape:'url'}{$COMMENT_IMG|strip_tags:false|escape:'url'}"
